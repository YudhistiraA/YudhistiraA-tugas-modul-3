...
import Card from "../Lcrad"
import $ from "jquery";
class Lingkung  extends Component {  
    constructor(){
        super()
        this.state = {
            buku: [
                {
                    isbn:"12345", judul:"Lingkungan Hidup", penulis:"Nasional",
                    penerbit:"5 Juni", 
                    cover:"https://drive.google.com/uc?id=1ui-jyKgu3DqFyo7VKJu-FFXkaNQN3aSg"
                },
                {
                    isbn:"12346", judul:"Hari Pohon", penulis:"Internasional",
                    penerbit:"21 November", 
                    cover:"https://drive.google.com/uc?id=1rJDcCOmsd14NL6DG3Wps_kewZomGcLU-"
                },
                {
                    isbn:"54321", judul:"Hari Bumi", penulis:"Nasional",
                    penerbit:"22 april", 
